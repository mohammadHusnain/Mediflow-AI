    ...
    >
      <div className="relative flex items-start justify-between gap-4">
        <div className="min-w-0">
          <p className="animate-count-up font-sans text-[36px] font-extrabold leading-none text-ink">
            {count}
          </p>
...
export function DashboardErrorState({ message, onRetry }) {
  return (
    <section className={`${surfaceClass} p-10 text-center`}>
      ...
      <h2 className="font-sans text-[18px] font-normal italic text-slate">Something went wrong</h2>
...
export function DashboardEmptyState({
  ...
  return (
    ...
    >
      ...
      <p className="font-sans text-[18px] font-normal italic text-slate">{title}</p>
      {description ? (
