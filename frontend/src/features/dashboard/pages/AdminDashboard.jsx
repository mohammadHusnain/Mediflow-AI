...
export function AdminDashboard() {
  ...
  return (
    <div className="dashboard-stage space-y-5">
      <section className={`${surfaceClass} relative overflow-hidden p-6`}>
          ...
          >
            {isLoading ? (
              ...
              <div className="grid gap-6 2xl:grid-cols-[minmax(0,1fr)_250px]">
                ...
                <aside className="rounded-card border border-hairline/70 bg-canvas p-5 shadow-card">
                  <div className="flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-control bg-brand-light text-brand">
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="rounded-control bg-[#ECFDF5] px-3 py-3">
                      ...
                      <div className="rounded-control bg-[#FFF7ED] px-3 py-3">
          ...
          {appointmentsEnabled ? (
            <DashboardPanel title="Peak Booking Heatmap">
              <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_180px]">
                ...
                <aside className="rounded-card border border-hairline/70 bg-mist p-4">
                  <p className="text-[12px] font-semibold uppercase tracking-[0.08em] text-slate">
                    Peak booking
                  </p>
        ...
        <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.82fr)]">
          ...
          <DashboardPanel title="Operational Capacity Forecast">
            <div className="space-y-4">
              ...
              <div className="rounded-card border border-hairline/70 bg-canvas p-4">
                <p className="text-[12px] font-semibold uppercase tracking-[0.08em] text-slate">
                  Department coverage
                </p>
